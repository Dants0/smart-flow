...
function toDomain(row: CardRow): Card {
  return {
    ...
    devHints: row.devHints ?? undefined,
    ...
    unknownPaths: (row.unknownPaths as unknown as string[] | null) ?? undefined,
    ...
    committedFiles: (row.committedFiles as unknown as string[] | null) ?? undefined,
    prUrl: row.prUrl ?? undefined,
    jiraCommentAt: row.jiraCommentAt?.toISOString() ?? undefined,
  ...
  await prisma.$transaction([
    prisma.card.upsert({
      ...
      create: {
        ...
        commitHash: card.commitHash ?? null,
        committedFiles: (card.committedFiles as unknown as object) ?? undefined,
        prUrl: card.prUrl ?? null,
        jiraCommentAt: card.jiraCommentAt ? new Date(card.jiraCommentAt) : null,
      ...
      update: {
        ...
        branch: card.branch ?? null,
        commitHash: card.commitHash ?? null,
        committedFiles: (card.committedFiles as unknown as object) ?? Prisma.DbNull,
        prUrl: card.prUrl ?? null,
        jiraCommentAt: card.jiraCommentAt ? new Date(card.jiraCommentAt) : null,
      },
    }),
